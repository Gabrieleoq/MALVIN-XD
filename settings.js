...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "MALVIN-XD~x8p3yLbI#Rk83tGP_fkz-C10BScp1QXppmo80ShGOWotPzplEKkA",
// add your Session Id 

PREFIX: process.env.PREFIX || ".",
// add your prifix for bot

BOT_NAME: process.env.BOT_NAME || "Gigel v1.2",
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "400771048185",
// add your bot owner number

OWNER_NAME: process.env.OWNER_NAME || "Gigel v1.2",
// add bot owner name
...
LIVE_MSG: process.env.LIVE_MSG || "> ✦Hello nigga im alive AHHAHAHAH :* github.com/kingmalvn/MALVIN-XD",
// add alive msg here 
...
MODE: process.env.MODE || "public-group",
...
DEV: process.env.DEV || "400771048185",
